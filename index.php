...
// $users = DB::getInstance()->query('SELECT * FROM users');//instantiate the class DataBase and use the mysql query to get the column "user_name" from the table "users".
// if ($users->count())// if there are users.
// {
//     echo "we up<br>";
//     echo $users->get('users', array('user_name', '=', 'roman'));
